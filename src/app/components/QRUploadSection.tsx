    ...
    return (
        <section id="share-photos" className="relative z-10 py-24 px-4 md:px-8 max-w-7xl mx-auto">
            <div className="relative rounded-[2rem] overflow-hidden">
                {/* Gradient background */}
                <div className="absolute inset-0 bg-linear-to-br from-primary/20 via-background-dark to-secondary-accent/20" />
                <div className="absolute inset-0 bg-grid-pattern opacity-30" />
                <div className="absolute top-0 right-0 w-80 h-80 bg-primary/15 rounded-full blur-[100px]" />
                <div className="absolute bottom-0 left-0 w-80 h-80 bg-secondary-accent/15 rounded-full blur-[100px]" />
                        ...
                        <div className="shrink-0">
                            <div className="relative group">
                                ...
                                <div className="relative glass-card rounded-3xl p-8 text-center border-white/10">
                                    ...
                                    <p className="text-white font-bold text-sm mb-1">Scan with your camera</p>
                                   <p className="text-slate-500 text-xs">or visit  <Link href="/upload" className="text-primary font-semibold">/upload</Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
